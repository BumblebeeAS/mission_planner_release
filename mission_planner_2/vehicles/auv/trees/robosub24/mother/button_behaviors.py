...
from mission_planner_2.vehicles.auv.trees.robosub24.button.wait_for_button import (
...
def create_button_start_coinflip_root(
    reset_pose_srv_topic: str,
    controls_srv_topic: str,
    left_button_topic: str,
    right_button_topic: str,
    ...
    button_reset_pose = create_button_behavior_root(
        button_topic=left_button_topic,
        num_retries=button_retries,
        execute_behavior=srv_reset_pose,
    )
    ...
    button_enable_controls = create_button_behavior_root(
        button_topic=right_button_topic,
        num_retries=button_retries,
        execute_behavior=retry_enable_controls,
    )
