...
from mission_planner_2.vehicles.auv.trees.robosub24.slalom.channel_movement_reg import (
...
def create_slalom_root():
    ...
    cluster_srv_start_1 = py_trees_ros.service_clients.FromConstant(
        name="Start clustering service",
    ...
    cluster_srv_stop_1 = py_trees_ros.service_clients.FromConstant(
        name="Stop clustering service",
    ...
    cluster_srv_start_2 = py_trees_ros.service_clients.FromConstant(
        name="Start clustering service",
        service_name=CLUSTERING_START_SERVICE_NAME,
        service_type=ClusterSlalomTfsStart,
        service_request=create_slalom_clustering_start_srv_request(
    ...
    cluster_srv_stop_2 = py_trees_ros.service_clients.FromConstant(
        name="Stop clustering service",
        service_name=CLUSTERING_STOP_SERVICE_NAME,
        service_type=ClusterSlalomTfsStop,
        service_request=create_slalom_clustering_stop_srv_request(
    ...
    cluster_srv_start_3 = py_trees_ros.service_clients.FromConstant(
        name="Start clustering service",
        service_name=CLUSTERING_START_SERVICE_NAME,
        service_type=ClusterSlalomTfsStart,
        service_request=create_slalom_clustering_start_srv_request(
    ...
    cluster_srv_stop_3 = py_trees_ros.service_clients.FromConstant(
        name="Stop clustering service",
        service_name=CLUSTERING_STOP_SERVICE_NAME,
        service_type=ClusterSlalomTfsStop,
        service_request=create_slalom_clustering_stop_srv_request(
    ...
    seq_move_and_cluster = py_trees.composites.Sequence(
        ...
        children=[
            move_view_one,
            cluster_srv_start_1,
            py_trees.timers.Timer(duration=CLUSTER_VIEW_DURATION),
            cluster_srv_stop_1,
            move_view_two,
            cluster_srv_start_2,
            py_trees.timers.Timer(duration=CLUSTER_VIEW_DURATION),
